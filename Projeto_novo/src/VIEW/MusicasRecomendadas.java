...
public class MusicasRecomendadas extends javax.swing.JFrame {
    ...
    int id;
     ...
     public MusicasRecomendadas(int userId) {
        initComponents();
    ...
    private void btnRecomendacoesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRecomendacoesActionPerformed
        RecomendacaoDAO recomd = new RecomendacaoDAO();
        //recomd.navd(id);
        //recomd.fv(id);
    ...
    private ArrayList<MusicaDTO> recomendacao() {
        
          
             RecomendacaoDAO recomd = new RecomendacaoDAO();
             MusicaDTO objmusicaDTO = new MusicaDTO();
            
            for( MusicaDTO lista: recomd.navd(id)){
                int contador = 0;    
                int acumulador = 0;
                int posto = 0;
                String nomeNaoAvaliado = objmusicaDTO.getNome_musica();
                for(MusicaDTO lista2: recomd.fv(id)){
                    String avaliado = objmusicaDTO.getNome_musica();
                    if(nomeNaoAvaliado.equals(avaliado)){
                        contador = contador + 1;
                        acumulador = acumulador + objmusicaDTO.getAvaliacao();
                    }
                }
                if(contador == 0){
                    posto = 0;
                ...
                MusicaDTO recomendacao = new MusicaDTO(objmusicaDTO.getNome_musica(), posto);
                
                recomendacao.add(recomendacao);
            }            
    }   
...
//            //MusicaDTO objmusicaDTO = new MusicaDTO();
//            DefaultTableModel model = (DefaultTableModel) tabelaMusicasRecomendadas.getModel();
//            model.setNumRows(0);
//            
//            ArrayList<MusicaDTO> lista2 = objmusicaDAO.pegarNomeMusica(id);
//            
//            //System.out.println(objmusicaDTO.getNome_musica());
//            
//            for(int num = 0; num < lista2.size(); num ++){
//                model.addRow(new Object[]{
//            /*ENQUANTO HOUVER DADOS NO ARRAYLIST MOSTRAR NA TABELA.*/
//                    lista2.get(num).getNome_musica()
//                });
//            }    
//        } catch (Exception erro){
//            JOptionPane.showMessageDialog(null, "Erro ao listar as musicas recomendadas: " + erro);
//        }
//      
//    }
